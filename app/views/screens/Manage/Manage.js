...
//         <Container>
//           <ScrollView
//             scrollEnabled={activeView == 'table' ?true:false}
//             ref={c => {
//               this.scroll = c;
//             }}
...
//             <Content scrollEnabled={activeView == 'table' ?true:false}>
      ...
      <SafeAreaView
        ...
        <Container>
          <ScrollView
            ...
            overScrollMode={'always'}
            onScroll={event => this.handleScroll(event)}
            marginBottom={activeView == 'map'?-50:0}>
            <CustomeHeader {...this.props} />
            <Content marginBottom={activeView == 'map'?-50:0}>
              <View style={{margin: 10}}>
                <View
                  style={{
                    flexDirection: 'row',
