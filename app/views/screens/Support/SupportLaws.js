...
class SupportLaws extends Component {
...
export default withTranslation()(SupportLaws);
...
class LAW extends Component {
	...
	render() {
		return (
			<View>
				<H3 style={{fontFamily:'RacingSansOne-Regular', marginTop: 25, marginBottom: 5}}>{this.props.propsVal.t('Excavation Law')} </H3>
				<Button block style={{backgroundColor: "#fdbe25", marginBottom: 15}} onPress={() => Linking.openURL('https://usanorth811.org/images/pdfs/CA-LAW-2018.pdf') } >
						<H3 style={{color:"#000" }}>{this.props.propsVal.t('California')}</H3>
				</Button>
				<Button block style={{backgroundColor: "#fdbe25"}} onPress={() => Linking.openURL('https://usanorth811.org/images/pdfs/NV-LAW-English.pdf') }>
						<H3 style={{color:"#000" }}>{this.props.propsVal.t('Nevada')}</H3>
				</Button>
			</View>
		);
	}
