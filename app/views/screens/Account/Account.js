...
class Account extends Component {
  ...
  _updateAccount(data) {
    ...
    fetch(
      config.BASE_URL +
        "update_account_information?api_token=" +
        config.currentToken,
      {
        method: "POST",
        headers: {
    ...
    return (
      <Item picker>
        <Picker
          ...
          {data.map((option, i) => {
            return <Picker.Item key={i} label={option.k} value={option.v} />;
          })}
        </Picker>
      </Item>
    );
        ...
        <Container>
          ...
          <Content>
            <View style={{ margin: 10 }}>
              <H1
                style={{ fontFamily: "RacingSansOne-Regular", marginTop: 20 }}>
                {this.props.t("ACCOUNT SETTINGS")}
              </H1>
              <H3
                style={{ fontFamily: "RacingSansOne-Regular", marginTop: 10 }}>
              ...
              <Form>
                ...
                <Item regular style={{ backgroundColor: "#fff", marginTop: 5 }}>
                  <Input
                    ...
                    defaultValue={this.state.c_phone}
                    maxLength={14}
                    onChangeText={(text) => this.onTextChange("c_phone", text)}
                  />
                </Item>
              </Form>
              <View style={{ marginTop: 10, marginBottom: 20 }}>
                <Text>
                  {this.props.t(
                    "Your preferred method of communication. This is where system notifications will be sent."
                  )}
                </Text>
                <View
                  style={{
                  ...
                  <TouchableOpacity
                    ...
                    onPress={() => this.changeBox("email")}>
                    {Platform.OS === "ios" ? (
                      <Icon
                        name={
                          this.state.communicate_method == "email"
                            ? "checkbox"
                            : "md-square-outline"
                        }
                      />
                  ...
                  <TouchableOpacity
                    ...
                    onPress={() => this.changeBox("phone")}>
                    {Platform.OS === "ios" ? (
                      <Icon
                        name={
                          this.state.communicate_method == "phone"
                            ? "checkbox"
                            : "md-square-outline"
                        }
                      />
              ...
              <H3
                ...
                {this.props.t("Company Information")}
              </H3>
              <Form>
                <Label style={{ marginTop: 10 }}>
                ...
                <Item regular style={{ backgroundColor: "#fff", marginTop: 5 }}>
                  <Input
                    ...
                    editable={false}
                    value={this.state.companyinfo.address1}
                  />
                </Item>
                <Label style={{ marginTop: 10 }}>
              ...
              <Form>
                <Label style={{ marginTop: 10 }}>
                  {this.props.t("Company Type")}
                </Label>
                <Item regular style={{ backgroundColor: "#fff", marginTop: 5 }}>
                  <Input
                    placeholder="Company Type"
                    editable={false}
                    value={this.state.companyinfo.type}
                  />
                </Item>
                <Label style={{ marginTop: 10 }}>
                ...
                <Item regular style={{ backgroundColor: "#fff", marginTop: 5 }}>
                  <Input
                    ...
                    editable={false}
                    value={this.state.companyinfo.industry}
                  />
                </Item>
              </Form>
              <H3
                ...
                {this.props.t("Contact Information")}
              </H3>
              <Form>
                <Label style={{ marginTop: 10 }}>
                  {this.props.t("Phone(Office)")}
                </Label>
                <Item regular style={{ backgroundColor: "#fff", marginTop: 5 }}>
                  <Input
                    textContentType="telephoneNumber"
                    dataDetectorTypes="phoneNumber"
                    keyboardType="phone-pad"
                    defaultValue={this.state.o_phone}
                    maxLength={14}
                    onChangeText={(text) => this.onTextChange("o_phone", text)}
                  />
                </Item>
                ...
                <Item regular style={{ backgroundColor: "#fff", marginTop: 5 }}>
                  <Input
                    ...
                    maxLength={14}
                    onChangeText={(text) => this.onTextChange("fax", text)}
                  />
                </Item>
                <Label style={{ marginTop: 10 }}>
                  {this.props.t("Alternate Contact Person")}
                </Label>
                <Item
                  regular
                  ...
                  <Input
                    ...
                    onChangeText={(text) =>
                      this.setState({ alt_contact: text.trim() })
                    }
                  />
                </Item>
                <Label style={{ marginTop: 10 }}>
                  {this.props.t("Alternate Phone")}
                </Label>
                <Item regular style={{ backgroundColor: "#fff", marginTop: 5 }}>
                  <Input
                    textContentType="telephoneNumber"
              ...
              <Button
                ...
                style={{ backgroundColor: "#FFBC42", marginTop: 25 }}>
                <H3 style={{ color: "#000", fontFamily: "OpenSans-SemiBold" }}>
              ...
              <Button
                ...
                style={{ backgroundColor: "#E05439", marginTop: 25,marginBottom:10}}>
                <Text
